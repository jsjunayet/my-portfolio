    ...
    return (
        <div className='ml-0 md:ml-2   max-w-5xl mx-auto md:mt-20 mt-6'>
           ...
           <div className=' space-y-3 px-3 flex-1 md:pt-8 mt-0  '>
                            <p className='text-base md:text-lg font-semibold'>I`m <span className='text-green-600'>Junayet Shiblu</span>, a Web Developer</p>
                            <p className='text-sm md:text-base text-[#a2a8a8]'> Passionate MERN stack developer who loves making user-friendly Website . I enjoy working with others to turn tricky ideas into smart solutions. I`m dedicated and a good team player, ready to bring my skills to your projects. Excited about creating cool web stuff together!</p>
